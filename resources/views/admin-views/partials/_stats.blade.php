<div class="col-sm-12 col-md-6 mb-3 mb-lg-5">
    <!-- Card -->
    <a class="card card-hover-shadow h-100" href="#" style="background: #003E47">
        <div class="card-body">
            <h4 class="card-subtitle"
                style="color: white!important;">{{translate('Total Generated eMoney')}}</h4>
...
<div class="col-sm-12 col-md-6 mb-3 mb-lg-5">
    ...
    <a class="card card-hover-shadow h-100" href="#" style="background: #5F7A61">
        <div class="card-body">
            <h4 class="card-subtitle"
                style="color: white!important;">{{translate('eMoney Being Used')}}</h4>
...
<div class="col-sm-12 col-md-6 mb-3 mb-lg-5">
    ...
    <a class="card card-hover-shadow h-100" href="#" style="background: #444941">
        <div class="card-body">
            <h4 class="card-subtitle"
                style="color: white!important;">{{translate('Unused eMoney')}}</h4>
...
<div class="col-sm-12 col-md-6 mb-3 mb-lg-5">
    ...
    <a class="card card-hover-shadow h-100" href="#" style="background: #7FC8A9">
        <div class="card-body">
            <h4 class="card-subtitle"
                style="color: white!important;">{{translate('Total Earn from Charges')}}</h4>
